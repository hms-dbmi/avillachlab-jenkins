...
echo "AUTH Database Migration: Begin"

export MIGRATION_SCRIPT_NAME="auth"
export CONTAINER_NAME="auth_migration_orchestrator_container"  
export S3_PROFILE_NAME=""
export S3_BUCKET_NAME="" 
export S3_IMAGE_FILE_NAME="picsure-db-migration-authschema-image.tar.gz"
export DOCKER_IMAGE="dbmi/pic-sure-db-migrations:picsure-db-migration-authschema-image"  
...
echo "AUTH Database Migration: End"